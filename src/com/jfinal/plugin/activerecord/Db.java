...
public class Db {
	...
	public static Page<Record> paginateForOrderby(int pageNumber, int pageSize, String select, String sqlExceptSelect, Object... paras) {
		return dbPro.paginateForOrderby(pageNumber, pageSize, select, sqlExceptSelect, paras);
	}
